...
public class Cores {
	...
	// Intensidade da cor 
	public static final String TEXT_BLACK_BRIGHT = "\u001B[30m";
	public static final String TEXT_RED_BRIGHT = "\u001B[31m";
	public static final String TEXT_GREEN_BRIGHT = "\u001B[32m";
	public static final String TEXT_YELLOW_BRIGHT = "\u001B[33m";
	public static final String TEXT_BLUE_BRIGHT = "\u001B[34m";
	public static final String TEXT_PURPLE_BRIGHT = "\u001B[35m";
	public static final String TEXT_CYAN_BRIGHT = "\u001B[36m";
	public static final String TEXT_WHITE_BRIGHT = "\u001B[37m";
	
	// Intensidade do texto em negrito
